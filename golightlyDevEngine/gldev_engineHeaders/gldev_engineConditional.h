...
#define GLDEV_ERROR_TYPE_READING_NO_ERROR_TO_WRITE 0
#define GLDEV_ERROR_TYPE_WRITING_RENDERING_ERROR 1
#define GLDEV_ERROR_TYPE_WRITING_LOADING_ERROR 2
#define GLDEV_ERROR_TYPE_WRITING_PROGRAM_CORE_ERROR 3

#define GLDEV_ERROR_FOUND true
#define GLDEV_ERROR_NOT_FOUND false
